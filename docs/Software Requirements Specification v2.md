...
- Internet connection required for default tasks database. [2.0]
- Local storage supported for offline persistence.

### 2.4 Design Constraints

- Responsive user interface.
- REST API communication.[2.0]
...
- Backend service is available when User first loads the application. [2.0]
- Database connection is enabled in the browser. [2.0]
