...
- **FR-12 Steps**
  ...
  ##### **Acceptance Criteria**
  - Steps must share all functional characteristics of a task, except adding steps to it.
  - A step must belong to a task.

- **FR-13 User Level**

  The System shall display a user level with progress bar displaying experience points acquired and experience points required to level up.

  ##### **Acceptance Criteria**
  - The System must calculate the user level based on experience thresholds.
