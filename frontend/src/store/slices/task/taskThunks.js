...
import { shouldReset } from "../../../utils/shouldReset.js";
import { resetSteps } from "../step/stepSlice.js";
...
export const fetchTasks = createAsyncThunk("task/fetchTasks", async () => {
  ...
  const nextId =
    response.data.length > 0
      ...
      : 1;
  localStorage.setItem("nextTaskId", nextId);
